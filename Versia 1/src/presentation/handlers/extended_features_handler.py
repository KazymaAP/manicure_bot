...
from html import escape  # BAG-9 FIX: перенесено из inline-импорта внутри хендлера
...
from src.application.dto.booking_dto import (
    CreateBookingDTO,  # BAG-8 FIX: перенесено из inline-импорта
)
from src.config.dependencies import Container
from src.domain.enums.fsm_states import AdminFSM, BookingFSM
from src.domain.exceptions.appointment import (  # BAG-8 FIX: перенесено из inline-импорта
