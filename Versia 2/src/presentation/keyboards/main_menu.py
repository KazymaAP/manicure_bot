...
class MainMenuKeyboard:
    ...
    def subscribe(channel_link: str) -> InlineKeyboardMarkup:
        ...
        # BUG 15 FIX: нормализуем username канала — убираем @ если он есть,
        # чтобы ссылка https://t.me/channel всегда была корректной.
        # Если передан полный URL (https://t.me/...) — используем как есть.
        if channel_link.startswith("https://") or channel_link.startswith("http://"):
